...
plotCI(i,median(moh[,2]), li = quantile(moh[,2],p/2), ui =quantile(moh[,2],1-p/2), xlim = c(0.3,8), ylim = c(-0.5,0.8),
       ...
       cex.main = 3, lwd = 2)
ww = which(moh[,2]<quantile(moh[,2],p/2) | moh[,2]>quantile(moh[,2],1-p/2))
points(rep(i,length(ww)),moh[ww,2],cex = 0.5)
i = 2
plotCI(i,median(moh[,3]), li = quantile(moh[,3],p/2), ui =quantile(moh[,3],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,3]<quantile(moh[,3],p/2) | moh[,3]>quantile(moh[,3],1-p/2))
points(rep(i,length(ww)),moh[ww,3],cex = 0.5)
i = 3
plotCI(i,median(moh[,4]), li = quantile(moh[,4],p/2), ui =quantile(moh[,4],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,4]<quantile(moh[,4],p/2) | moh[,4]>quantile(moh[,4],1-p/2))
points(rep(i,length(ww)),moh[ww,4],cex = 0.5)
i = 4
plotCI(i,median(moh[,5]), li = quantile(moh[,5],p/2), ui =quantile(moh[,5],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,5]<quantile(moh[,5],p/2) | moh[,5]>quantile(moh[,5],1-p/2))
points(rep(i,length(ww)),moh[ww,5],cex = 0.5)
i = 5
plotCI(i,median(moh[,6]), li = quantile(moh[,6],p/2), ui =quantile(moh[,6],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,6]<quantile(moh[,6],p/2) | moh[,6]>quantile(moh[,6],1-p/2))
points(rep(i,length(ww)),moh[ww,6],cex = 0.5)
i = 6
plotCI(i,median(moh[,7]), li = quantile(moh[,7],p/2), ui =quantile(moh[,7],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,7]<quantile(moh[,7],p/2) | moh[,7]>quantile(moh[,7],1-p/2))
points(rep(i,length(ww)),moh[ww,7],cex = 0.5)
i = 7
plotCI(i,median(moh[,8]), li = quantile(moh[,8],p/2), ui =quantile(moh[,8],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,8]<quantile(moh[,8],p/2) | moh[,8]>quantile(moh[,8],1-p/2))
points(rep(i,length(ww)),moh[ww,8],cex = 0.5)
i = 8
plotCI(i,median(moh[,9]), li = quantile(moh[,9],p/2), ui =quantile(moh[,9],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,i]<quantile(moh[,9],p/2) | moh[,9]>quantile(moh[,9],1-p/2))
points(rep(i,length(ww)),moh[ww,9],cex = 0.5)
...
i = 8
plotCI(i,median(moh[,9]), li = quantile(moh[,9],p/2), ui =quantile(moh[,9],1-p/2), add = TRUE, lwd = 2)
ww = which(moh[,9]<quantile(moh[,9],p/2) | moh[,9]>quantile(moh[,9],1-p/2))
points(rep(i,length(ww)),moh[ww,9],cex = 0.5)
abline(h = 0)
